...
*/
interface IMy {                     //поменял название интерфейса, чтобы начинался с I 
    public function funcP ();       //сделал метод публичным
}

interface IMy2 {                    //сделал еще один интерфейс (принцип по солиду)
...
class A {
    ...
    public function funcA (){       //сделал метод публичным
        return $this->prop2;
    }
}

class B extends A {
    public function funcB (){       //сделал метод публичным
        return $this->prop1;
    }
}

class C extends B implements IMy, IMy2 { //поменял название интерфейса, чтобы начинался с I. Реализую два интерфейса.
    ...
    public function funcI (){       //реализовал метод интерфейса
    }
}
